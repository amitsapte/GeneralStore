...
export const   arrayOfImage =[{producImage:'https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=90/app/images/category/cms_images/icon/922_1643384380004.png',
...
export const  item =[[{ percentage: 12 ,itemName:"Amul Taaza Toned Fresh Milk",price:56}, {itemName:"Amul Fresh Milk",price:26}, { percentage: 53 ,itemName:"Chitale Pasteurised Cow Fresh Milk",price:28}, {itemName:"Amul Gold Full Cream Fresh Milk",price:34}, {itemName:"Amul Cow Fresh Milk",price:28}
